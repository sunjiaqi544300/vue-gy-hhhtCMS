<template>
  <div class="qqMap" id="qqMap5" ref="qqMap"></div>
</template>
...
export default {
  ...
  mounted: function() {
    ...
    document.getElementById("qqMap5").style.height = windowH + "px";
  ...
  methods: {
             ...
             <h2>${vm.alertObj.shop_name}</h2>
                          <ul class="alertCont">
                              ...
                              <li style="display: flex;justify-content: space-between;background:#f5f6fa;padding:3px">
                               ...
                               <li style="display: flex;justify-content: space-between;background:#f5f6fa;padding:3px">
                                  <span style="font-size:13px;">实际单箱结构排名</span>
                                  <span style="font-size:13px;">${
                                    vm.alertObj.striprank != ""
                                      ? vm.alertObj.striprank
                                      : "暂无"
                                  }</span>
                              </li>
    ...
    drawMap() {
      ...
      TMap("H7KBZ-XMI66-4CXSJ-ERMEQ-UPCYZ-PABYG&libraries=convertor").then( qq => {
          vm.map = new qq.maps.Map(document.getElementById("qqMap5"), {
            // 地图的中心地理坐标。
